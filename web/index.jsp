...
<body>
	...
	<div class="row">
       ...
       <p>Số điện thoại: ${byName.phonenumber}</p> 
                                ...
                                <a href="WaterServlet?idclient=${byName.id}" class="btn btn-success">Tra cứu</a>
                                       <a href="showAddWaterServlet?idclient=${byName.id}" class="btn btn-success">
					Thêm tháng mới</a>
					...
					<c:forEach var="u" items="${listWater}">
						...
						<tr>
							...
							<td><c:out value="${u.trangthai}" /></td>
                                                        ...
                                                        <td><a href="PaymentServlet?idwater=${u.id}&thang=${u.thang}&idclient=${byName.id}">Thanh toán ngay </a></td>
							</c:if>
						</tr>
					</c:forEach>
					<!-- } -->
